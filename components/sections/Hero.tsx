                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="text-center lg:text-left">
                        ...
                        <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-4 leading-tight">
                            <span className="hero-title inline-block">Lakshmi</span>{' '}
                            <span className="hero-title inline-block">Chaitanya</span>{' '}
                            <span className="hero-title inline-block gradient-text">Sai</span>
                        </h1>
                        ...
                        <div className="hero-subtitle inline-flex items-center gap-2 px-4 py-2 glass border border-electric/30 rounded-full mb-8">
                            ...
                            <span className="text-offwhite/90 font-medium">CSE Cybersecurity Student</span>
                        </div>
                        ...
                        <div className="relative z-20 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-6">
                            ...
                            <MagneticButton
                                href="/P Lakshmi Chaitanya Sai_Resume(CS).pdf"
                                download="Lakshmi_Chaitanya_Sai_Resume.pdf"
                        ...
                        <div className="hero-subtitle flex gap-4 justify-center lg:justify-start mt-6">
                            {/* Instagram */}
                            <a
                                href="https://www.instagram.com/_urstrulysai__?igsh=MTVmbHAycHQ3ejdoYQ%3D%3D"
                                target="_blank"
                            ...
                            {/* X (Twitter) */}
                            <a
                                href="https://x.com/chaitanyasai401"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-12 h-12 glass border border-electric/30 rounded-full flex items-center justify-center hover:border-electric hover:bg-electric/10 transition-all duration-300 cursor-hover group"
                    ...
                    <div className="hero-image relative flex justify-center lg:justify-end">
                        <div className="relative">
                            ...
                            <div className="relative w-[400px] h-[530px] md:w-[480px] md:h-[610px] rounded-3xl overflow-hidden border-[6px] border-electric/60 shadow-2xl shadow-electric/30">
                                <Image
                                    src="/profile.jpg"
                                    alt="Lakshmi Chaitanya Sai"
                                    fill
