                    ...
                    <div className="text-center lg:text-left">
                        ...
                        <div className="relative z-20 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-6">
                            ...
                            <a
                                ...
                                download
                                className="hero-cta px-8 py-4 glass border-2 border-electric/50 text-offwhite rounded-full font-semibold text-lg hover:border-electric hover:bg-electric/10 transition-all duration-300 cursor-hover flex items-center gap-2 justify-center"
                            >
